document.addEventListener('DOMContentLoaded', () => {
  ...
  // ⭐ FUNCIÓN MODIFICADA PARA DIVISIONES EXACTAS ⭐
    function generateOperation() {
        // 1. Elegimos un divisor (bottomNum) entre 1 y 10 (la "tabla" a usar)
        ...
        // Nota: bottomNum siempre estará entre 1 y 10. topNum siempre será el más grande (o igual si multiplier es 1).
