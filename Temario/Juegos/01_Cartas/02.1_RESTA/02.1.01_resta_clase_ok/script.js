document.addEventListener('DOMContentLoaded', () => {
    ...
    // Función para generar una operación simple (SOLO RESTAS POSITIVAS 0-10)
    function generateOperation() {
        // ✨ MODIFICACIÓN: Generar restas con resultado positivo (0 o mayor).
        
        // 1. Generar dos números de 0 a 10.
        let num1 = Math.floor(Math.random() * 11); // 0 a 10
        let num2 = Math.floor(Math.random() * 11); // 0 a 10
        
        // 2. Asegurarse de que el primer número (num1) sea mayor o igual que el segundo (num2)
        // para garantizar que la resta sea positiva o cero.
        const topNum = Math.max(num1, num2); // Número mayor
        const bottomNum = Math.min(num1, num2); // Número menor
