document.addEventListener('DOMContentLoaded', () => {
    ...
    // ✨ MODIFICACIÓN CLAVE: Resta (0-20) - (0-10) con resultado positivo.
        
        let numA; // Minuendo (0 a 20)
        let numB; // Sustraendo (0 a 10)
        
        // Generar Sustraendo (0 a 10)
        numB = Math.floor(Math.random() * 11); 
        
        // Generar Minuendo (0 a 20)
        numA = Math.floor(Math.random() * 21);
        
        // Asegurar que numA >= numB para que el resultado sea >= 0.
        // Si numA es menor, se regenera.
        while (numA < numB) {
            numA = Math.floor(Math.random() * 21);
        }
    ...
    // Asignación de listeners a los botones de respuesta
