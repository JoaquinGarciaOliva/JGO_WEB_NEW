document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateOperation() {
        // ✨ MODIFICACIÓN: Números del 0 al 10.
        // Math.random() * 11 genera números entre 0 (incluido) y 11 (excluido). 
        // Math.floor() asegura que los resultados sean 0, 1, 2, ..., hasta 10.
        const num1 = Math.floor(Math.random() * 11); // 0 a 10
        const num2 = Math.floor(Math.random() * 11); // 0 a 10
        
        const operator = '+'; // Solo sumas
        const topNum = num1;
